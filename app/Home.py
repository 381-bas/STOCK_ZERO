...
def main():
    ...
    if modo == "CONTROL GESTION":
        ...
        try:
            ...
            scope_page, scope_offset = _cg_get_page_state("page_cg_scope", page_size=25)
            ...
            with st.expander("Alertas", expanded=False):
                page_alertas, offset_alertas = _cg_get_page_state("page_cg_alertas", page_size=25)
            ...
            with st.expander("Detalle evidencia", expanded=False):
                page_det, offset_det = _cg_get_page_state("page_cg_detalle", page_size=25)
            ...
            with st.expander("Parity", expanded=False):
                page_parity, offset_parity = _cg_get_page_state("page_cg_parity", page_size=25)
