...
def get_tabla_scope_responsable_total_page(
    ...
    sql = f"""
        ...
        FROM base
        ORDER BY negativos DESC, quiebres DESC, venta_0 DESC, responsable ASC
        {page_sql}
    """
    return qdf(sql, params)
...
def get_tabla_scope_cliente_total_page(
    ...
    sql = f"""
        ...
        SELECT
            ...
            COUNT(*) OVER()::int AS total_rows
        FROM base
        ORDER BY negativos DESC, quiebres DESC, venta_0 DESC, cliente ASC
        {page_sql}
    """
    return qdf(sql, params)
...
def get_tabla_scope_local_total_page(
    ...
    sql = f"""
        ...
        SELECT
            ...
            COUNT(*) OVER()::int AS total_rows
        FROM base
        ORDER BY negativos DESC, quiebres DESC, venta_0 DESC, cod_rt ASC
        {page_sql}
    """
    return qdf(sql, params)
