...
def get_detalle_sku_scope_total_page(
    ...
    sql = f"""
        ...
        FROM {SCOPE_FACT_BRIDGE_VIEW} b
        LEFT JOIN rr_ctx
            ON rr_ctx.cod_rt = b.cod_rt
           AND rr_ctx.cliente_norm_match = {_scope_norm_expr('b.cliente')}
           AND rr_ctx.responsable_tipo_match = {_scope_norm_expr('b.responsable_tipo')}
           AND rr_ctx.responsable_norm_match = {_scope_norm_expr('b.responsable')}
        WHERE 1=1
        {where_extra}
        ORDER BY
